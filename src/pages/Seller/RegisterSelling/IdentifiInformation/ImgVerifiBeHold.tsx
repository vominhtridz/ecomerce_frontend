...
const ImgVerifiBeHold = ({ ImgHoldErr }: any) => {
  ...
  return (
    <nav className='flex  py-2'>
      <div className='flex pt-1 mr-4  w-[11rem] justify-end text-[13.5px]'>
        ...
        Ảnh đang cầm CMND/CCCD/Hộ chiếu của bạn
      </div>
      <div className='w-1/2 '>
        ...
        {ImgHoldErr && (
          <p className='text-[12px] leading-5 text-red-500'>
            Vui lòng đăng tải ảnh đang cầm CMND/CCCD/Hộ chiếu của bạn theo hướng dẫn trên.
          </p>
        )}
        <p className='text-[10.5px] leading-4'>
          Vui lòng Gửi CMND/CCCD/Hộ chiếu CHỤP KHI BẠN CẦM <strong className='text-green-600'>MẶT TRƯỚC VÀ SAU</strong> Các thông tin trong
          CMND/CCCD/Hộ chiếu phải được hiển thị rõ ràng (Kích thước ảnh không vượt quá 5.0 MB)
        </p>
      </div>
    </nav>
  )
...
export default ImgVerifiBeHold
