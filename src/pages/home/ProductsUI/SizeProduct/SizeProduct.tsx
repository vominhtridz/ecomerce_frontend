  ...
  return (
    <section className='flex items-center justify-between pb-2'>
      <nav className='flex items-center'>
        ...
        <p className=' whitespace-nowrap max-md:text-base'>{language?.center.products.totalProducts}</p>
      </nav>
      <nav className='flex items-center '>
        <div className='flex items-center lg:mr-6 max-lg:mr-2 border max-md:text-[12px] font-semibold border-solid rounded-sm border-slate-400'>
