...
import { NavLinkAddressTypes } from "../../../typescript/AddressTypes"

const NavLinkAddress: FC<NavLinkAddressTypes> = ({
  setRouteAddress,
  RouteAddress,
  setBooleanWard,
  setbooleanProvince,
  ...
  return <div className='flex items-center w-full'>{getManageNavLinkAddress}</div>
}
